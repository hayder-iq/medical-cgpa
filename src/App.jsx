    ...
    <div className="fade-up" style={{ minHeight: "100dvh", background: C.bg, color: C.text, padding: "32px 24px", maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 24, padding: "20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          ...
          <div style={{ fontSize: 12, color: C.muted }}>Page {page + 1}/{pages}</div>
        </div>
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text }}>
      ...
      {/* Header مع أزرار في المنتصف */}
      <div style={{
        position: "sticky", top: 0, zIndex: 100,
        background: C.hdr, backdropFilter: "blur(20px)",
        borderBottom: `1px solid ${C.border}`,
        padding: "0 24px", height: 64,
        display: "flex", alignItems: "center", justifyContent: "space-between"
      }}>
        {/* القسم الأيسر - Logo + Telegram */}
        <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1 }}>
          <div style={{
            width: 36, height: 36, borderRadius: 10,
            background: "linear-gradient(135deg,#00D4AA,#3B82F6)",
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 16, fontFamily: "'Bebas Neue'", color: "white"
          }}>M</div>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", flex: 1 }}>
          <button
            ...
            onMouseEnter={(e) => e.currentTarget.style.background = dark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.05)"}
